...
exports.getUser = async (req, res, next) => {
  ...
  if (req.req_user.id === req.params.user_id) {
    ...
    user = Object.assign(user.toObject(), {
      ethereum_account_balance: ethereumHelper.weiToEther(userAccountBalance),
      ethereum_account_balance_ether: userAccountBalance
    });
  }
...
exports.updateUser = (req, res, next) => {
  ...
  ['password',
    ...
    'ethereum_account_private_key'].forEach(key => delete req.body[key]);
